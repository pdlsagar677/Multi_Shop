    ...
    <div className="min-h-screen flex items-center justify-center p-6" style={{ backgroundColor: theme.bgColor }}>
      <div className="w-full max-w-md">
        <div className="flex items-center gap-2 mb-10 justify-center">
          ...
          <span className="text-xl font-black text-gray-900">{store?.storeName || "Store"}</span>
        </div>

        <div className="text-center mb-8">
          <div className="w-14 h-14 rounded-2xl flex items-center justify-center mx-auto mb-4" style={{ backgroundColor: theme.secondaryColor }}>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {isSubmitting ? <div className="w-5 h-5 border-2 border-current border-t-transparent rounded-full animate-spin" /> : "Set Password & Continue"}
          </button>
        </form>
      </div>
    </div>
