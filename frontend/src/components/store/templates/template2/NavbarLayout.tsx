        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center gap-2.5 shrink-0">
            {store.branding.logo ? (
              ...
              <div
                className="w-9 h-9 rounded-full flex items-center justify-center font-black text-base shadow-sm"
                style={{
          ...
          <div className="hidden md:flex items-center justify-center flex-1">
            <Link
              href="/"
              className="text-sm font-semibold tracking-wide uppercase opacity-80 hover:opacity-100 transition-opacity"
              style={{ color: theme.navText }}
            >
              Shop
            </Link>
          ...
          <div className="flex items-center gap-2">
            ...
            {isCustomer && (
              <Link
                href="/cart"
                className="relative p-2.5 rounded-full transition-colors hover:bg-white/10"
                style={{ color: theme.navText }}
              >
            ...
            {user ? (
              <Link
                ...
                className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-full text-sm font-semibold transition-colors hover:bg-white/10"
                style={{ color: theme.navText }}
              >
                <User size={16} />
                {user.name.split(" ")[0]}
